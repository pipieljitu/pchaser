...
def main():
 ...
 ____           ____     __  __  ______  ____    ____    ____       
/\  _`\        /\  _`\  /\ \/\ \/\  _  \/\  _`\ /\  _`\ /\  _`\     
\ \ \L\ \      \ \ \/\_\\ \ \_\ \ \ \L\ \ \,\L\_\ \ \L\_\ \ \L\ \   
 \ \ ,__/_______\ \ \/_/_\ \  _  \ \  __ \/_\__ \\ \  _\L\ \ ,  /   
  \ \ \//\______\\ \ \L\ \\ \ \ \ \ \ \/\ \/\ \L\ \ \ \L\ \ \ \\ \  
   \ \_\\/______/ \ \____/ \ \_\ \_\ \_\ \_\ `\____\ \____/\ \_\ \_\
    ...
    """)
    print("\n^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^")
    print("\n< Copyright of Pipieljitu, 2022                                    >")
    print("\n< https://github.com/pipieljitu                                    >")
    print("\n< https://www.instagram.com/pipieljitu/                            >")
    print("\n^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^")
